            ...
            {!isLoading || (isFetching && <SpinnerTable />)}{" "}
                ...
                result.data.map((item, key) => (
                  <tr key={key}>
                    ...
                    {store.isDelete && <ModalDelete setIsDelete={setIsDelete} mysqlApiDelete={`/v2/level/${id}`}queryKey="level"/>}

                    {store.isRestore && <ModalRestore setIsRestore={setIsRestore} mysqlEndpoint={`/v2/level/active/${id}`}queryKey="level"/>}

                    {store.isArchive && <ModalArchive setIsArchive={setIsArchive} mysqlEndpoint={`/v2/level/active/${id}`} queryKey="level"/>}
